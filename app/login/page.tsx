        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
            <div className="max-w-md w-full mx-4">
                ...
                <div className="bg-white dark:bg-zinc-800 p-8 shadow-2xl border border-gray-200 dark:border-gray-700" style={{ borderRadius: '0.5rem' }}>
                    ...
                    {error && (
                        <div className="mb-4 p-3 bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 text-sm rounded-lg font-sans">
                            {error}
                        </div>
                    )}
                    ...
                    <form onSubmit={handleEmailSignIn} className="space-y-4 mb-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-zinc-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-slate-500 outline-none transition-all font-sans"
                                placeholder="name@company.com"
                                required
                            />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 font-sans">Password</label>
                            <input
                                type="password"
                                value={password}
                        ...
                        <button
                            ...
                            className="w-full py-2.5 bg-slate-800 dark:bg-slate-700 text-white rounded-lg hover:bg-slate-700 dark:hover:bg-slate-600 transition-colors font-sans font-medium"
                        >
                    ...
                    <div className="relative mb-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-white dark:bg-zinc-800 text-gray-500 font-sans">Or continue with</span>
                        </div>
                    </div>
