...
export default function ImedaInvoiceDetailPage() {
    ...
    const contactEmail = 'hello@imeda.ae';
            ...
            <style dangerouslySetInnerHTML={{
                ...
                @media print {
                    ...
                    #invoice-a4-page {
                        ...
                        margin: 0 !important; padding: 48px !important;
                    ...
                    <div className="grid grid-cols-2 gap-4 border-t pt-4">
                            ...
                            <div className="space-y-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-gray-500 leading-relaxed">
                                        Please send payment confirmation to <span className="font-medium" style={{ color: brandColor }}>{contactEmail}</span>.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg border border-gray-100 h-full">
                            ...
                            {invoice.bank_account ? (
                                ...
                                <p className="text-gray-400 italic text-xs">No bank details attached.</p>
                            )}
                        </div>
                    </div>
                </div>
