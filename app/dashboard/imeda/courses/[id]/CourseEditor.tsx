...
export default function EditImedaCoursePage() {
    ...
    const loadCourse = async () => {
        ...
        try {
            ...
            if (data) {
                ...
                setModules(data.modules || [{ title: '', order: 1 }]);
            }
        } catch (error) {
    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center py-20">
                <span className="text-gray-500 font-sans">Loading course...</span>
            </div>
        );
    }
            ...
            <div className="flex items-center justify-between sticky top-0 bg-gray-50 dark:bg-black z-10 py-4 border-b border-gray-200 dark:border-gray-800 -mx-8 px-8 mb-6">
                ...
                <div className="flex gap-3">
                    <button
                        ...
                        className="p-2.5 text-red-500 hover:bg-red-50 dark:hover:bg-red-900/10 transition-colors disabled:opacity-50"
            ...
            <form onSubmit={handleSubmit} className="max-w-5xl mx-auto space-y-8">
                ...
                <div className="bg-white dark:bg-zinc-800 p-8 border border-gray-200 dark:border-gray-700 shadow-sm" style={{ borderRadius: '0.5rem' }}>
                    ...
                    <div className="space-y-6">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Objectives</label>
                            <textarea
                                rows={3}
