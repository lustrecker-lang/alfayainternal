...
export default function NewExpensePage() {
    ...
    const handleSave = () => {
        ...
        const expenseData = {
            ...formData,
            unitId: 'afconsult', // Hardcoded for AFCONSULT context
            proofFileName: proofFile?.name,
            totals: calculateTotal(),
        };
        console.log('Expense data to save:', expenseData);
        alert('Save functionality - would create new expense and redirect');
    };

    // If type is invoice, redirect to the invoice form
    if (isInvoice) {
        return (
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-3xl text-gray-900 dark:text-white">New Invoice</h1>
                </div>
                <p className="text-gray-600 dark:text-gray-400">Invoice form coming soon...</p>
            </div>
        );
    }
