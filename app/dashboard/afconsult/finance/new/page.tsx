...
export default function NewInvoicePage() {
    ...
    const handleSave = () => {
        alert('Save functionality - would create new invoice and redirect');
    };
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-3xl text-gray-900 dark:text-white">
                        {type === 'invoice' ? 'New Invoice' : 'New Expense'}
                    </h1>
                </div>
                <button
                    onClick={handleSave}
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder={type === 'invoice' ? 'INV-2026-001' : 'EXP-2026-001'}
                    ...
                    <div className="bg-white dark:bg-zinc-800 p-6 border border-gray-200 dark:border-gray-700" style={{ borderRadius: '0.5rem' }}>
                        ...
                        <div className="space-y-2 text-sm font-sans">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="text-gray-900 dark:text-white">{formData.currency} {calculateTotal().toFixed(2)}</span>
                            </div>
                        </div>
                    </div>
                </div>
