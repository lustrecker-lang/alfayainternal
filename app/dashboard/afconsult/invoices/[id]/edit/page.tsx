...
export default function EditInvoicePage() {
    ...
    const onSubmit = async (data: NewInvoiceData) => {
        ...
        try {
            ...
            router.push(`/dashboard/afconsult/invoices/${params.id}`);
        } catch (error) {
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                <Link href={`/dashboard/afconsult/invoices/${params.id}`} className="p-2 hover:bg-gray-100 dark:hover:bg-zinc-800 rounded-full transition-colors">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="fixed bottom-6 right-6 flex gap-4">
                    <button
                        type="button"
                        onClick={() => router.push(`/dashboard/afconsult/invoices/${params.id}`)}
