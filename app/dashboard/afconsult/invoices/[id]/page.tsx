...
export default function InvoiceDetailPage() {
    ...
    // Theme Hook - hardcoded to afconsult for this context as it's under afconsult dashboard
    const { brand, loading: brandLoading } = useBrandTheme('afconsult');
                ...
                <div className="flex gap-3">
                    ...
                    {!isPaid && (
                        <TransactionDialog
                            ...
                            brandColor="afconsult" // Still passing for fallback/legacy prop but it uses hook internally now too
                            prefillData={{
                                type: 'INCOME',
                                amount: invoice.total_amount,
                                currency: currency,
                                category: 'Sales Revenue', // Default category
                    ...
                    <Link
                        href={`/dashboard/afconsult/invoices/${invoice.id}/edit`}
                    ...
                    <div className="flex justify-between items-start mb-12">
                        <div>
                            ...
                            <div className="text-gray-500 text-xs mt-2">
                                <p className="font-semibold text-gray-700 text-sm">{brand?.display_name || 'AF Consult'}</p>
                        ...
                        <div className="text-right">
                            ...
                            <div className="space-y-1 text-gray-600">
                                ...
                                {/* Display Currency if not default AED, good for clarity */}
