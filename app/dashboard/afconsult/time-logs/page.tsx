                ...
                <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                        {LOGS.map((log) => (
                            <tr key={log.id} className="hover:bg-gray-50/50 dark:hover:bg-zinc-700/30 transition-colors">
                                ...
                                <td className="px-6 py-4 text-sm font-normal text-gray-600 dark:text-gray-400 font-sans">{log.consultant}</td>
                                <td className="px-6 py-4 text-sm font-normal text-gray-600 dark:text-gray-400 font-sans">{log.client}</td>
                                <td className="px-6 py-4 text-sm font-normal text-gray-600 dark:text-gray-400 line-clamp-1 font-sans">{log.description}</td>
                    ...
                    <tfoot>
                        <tr className="bg-gray-50/50 dark:bg-zinc-900/50 font-normal border-t border-gray-200 dark:border-gray-700">
                            <td colSpan={4} className="px-6 py-4 text-right text-gray-500 font-sans">Total Recorded</td>
